	...
	var dzTheme = function(){
		...
		if(screenWidth <= 991)
		{
			if($('.mo-left .header-nav').children('.logo-header').length == 0){
				...
				jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','images/logo3.png');
				jQuery('.header-style-2.mo-left .header-nav .logo-header > a > img').attr('src','images/logo3.png');
				jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src','images/logo3.png.png');
				jQuery('.mo-left .header-nav .logo-header.dark > a > img').attr('src','images/logo3.png');
			}
