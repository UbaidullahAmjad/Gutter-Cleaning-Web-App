                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-4">Total Bookings</h5>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-1">Finished Bookings</h5>
                                    <span class="h2 font-weight-bold mb-0">{{ $finished_bookings }}</span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-1">Package Subscriptions</h5>
                                    <span class="h2 font-weight-bold mb-0">{{ $subscriptions }}</span>
                                </div>
                                <div class="col-auto">
