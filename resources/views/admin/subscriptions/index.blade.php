                            ...
                            <tr>
                                ...
                                <td class="" colspan="">
                                    ...
                                    <form
                                        ...
                                        <?php
                                        if($subscription->active == 0 || $subscription->active == 2){
                                            echo "<a class=\"btn btn-sm btn-icon-only\"
                                       href=\"" .  route('admin.subscriptions.changeStatus', ['subscription'=>$subscription->id]) .  "\"><i class=\"fas fa-toggle-off\"></i></a>";
                                        }
                                        if($subscription->active == 1){
                                            echo "<a class=\"btn btn-sm btn-icon-only\"
                                       href=\"" .  route('admin.subscriptions.changeStatus', ['subscription'=>$subscription->id]) . "\"><i class=\"fas fa-toggle-on\"></i></a>";
                                        }
                                        ?>
                                </td>
                            </tr>
