                ...
                <div class="card bg-secondary border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3"><span class="font-weight-bold">Customer Name:</span>
                                {{ $booking->guest->name }}
                            </div>
                            <div class="col-md-6 mb-3"><span class="font-weight-bold">Customer Email:</span>
                                {{ $booking->guest->email }}
                            </div>
                            <!--<div class="col-md-6 mb-3"><span class="font-weight-bold">Customer Phone #:</span>-->
